...
export const STUDENT_POTENTIAL_DETAILED_MISSION = '/student/potential-detailed-mission'
export const STUDENT_STATISTICS = '/student/statistics'
export const STUDENT_GROUP = '/student/group'
export const STUDENT_MISSION_CHAT = '/student/mission/chat/59'
export const STUDENT_PRE_MISSION_CHAT = '/student/pre_mission/chat/61'
...
export const COMPANY_PRE_MISSION_CHAT = '/company/pre_mission/chat/:missionId'
