...
function AdminVerifyCompanyContent (): JSX.Element {
          ...
          <TableBody>
            {pendingDocuments.map((row) => {
              if (
                ...
                row.companyId?.toString().toLowerCase().includes(searchTerm.toLowerCase()) ||
...
export default AdminVerifyCompanyContent
