...
function CompanyGoogleLoginPage() {
  ...
  useEffect(() => {
    ...
    fetch(`${process.env.REACT_APP_API_URL as string}/api/auth/company/google/code`, requestOptions)
        .then((res) => res.json())
        .then((res) => {
...
export default CompanyGoogleLoginPage
